...
public class Problem_11 {
    public static void main(String[] args) {
        ...
        for (int row = 0; row < grid.length; row++) {
            for (int column = 3; column < grid[0].length - 3; column++) {
        ...
        for (int row = 0; row < grid.length - 3; row++) {
            for (int column = 0; column < grid[0].length - 3; column++) {
                product = grid[row][column] * grid[row + 1][column + 1] * grid[row + 2][column + 2]
                        * grid[row + 3][column + 3];
                if (product > maximum_product) {
                    maximum_product = product;
                }
        ...
        for (int row = 0; row < grid.length - 3; row++) {
            for (int column = grid[0].length - 1; column > 2; column--) {
                product = grid[row][column] * grid[row + 1][column - 1] * grid[row + 2][column - 2]
                        * grid[row + 3][column - 3];
                if (product > maximum_product) {
                    maximum_product = product;
